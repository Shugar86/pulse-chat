...
- [Характер проекта](#характер-проекта)
...
**Вайб:** `trusted` — «мессенджер, который не торгует приватностью».

1. **Приватность не на словах.** VPN-ключи генерируются на устройстве и никогда его не покидают.
2. **Свой сервер, свои данные.** Сообщения и звонки идут через вашу инфраструктуру, без сторонних мессенджеров.
3. **Честный статус.** Что готово — помечено ✅; обещания вроде E2E-шифрования живут в дорожной карте, а не в маркетинге.
